...
const vec4 TRAIL_COLOR = vec4(0.973, 0.694, 0.0, 0.41);
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // When drawing a parallelogram between cursors for the trail i need to determine
    // where to start at the top-left or top-right vertex of the cursor
