...
alias cr  'claude --dangerously-skip-permissions -r'
alias cc  'CLAUDE_CONFIG_DIR=$HOME/.claude-w claude --dangerously-skip-permissions'
alias ccw 'npx cc-wiretap'
alias ccw-setup 'eval "$(curl -s http://localhost:8082/setup?shell=fish)"'

alias ops 'openspec list'

alias opc 'opencode'
alias pi  'bunx @mariozechner/pi-coding-agent'
alias skl 'bunx skills'

alias bmad 'bunx bmad-method'
alias skit 'uvx --from git+https://github.com/github/spec-kit.git specify'
