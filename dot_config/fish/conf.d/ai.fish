...
alias cl  'bunx @anthropic-ai/claude-code'
alias clw 'npx cc-wiretap'

alias mycl 'CLAUDE_CONFIG_DIR=$HOME/.claude-home CLAUDE_CREDS_SUFFIX=2da18b10 bunx @anthropic-ai/claude-code'
