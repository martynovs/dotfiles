...
import { brew, cargo, cargobin, universal, printScript } from '../helpers.ts';

printScript(
    universal('clang'),
    brew('rustup && rustup-init -y -c rust-analyzer'),
    brew('sccache'), // build cache
    ...
    cargobin('cargo-semver-checks'), // check semver violations https://github.com/obi1kenobi/cargo-semver-checks
    cargobin('cargo-expand'),        // show result of macro expansion https://github.com/dtolnay/cargo-expand 
    cargobin('cargo-outdated'),      // find outdated dependencies https://github.com/kbknapp/cargo-outdated
    cargobin('cargo-shear'),         // remove unused dependencies https://github.com/Boshen/cargo-shear
